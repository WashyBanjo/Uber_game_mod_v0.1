...
- `game.py` owns graph-relative vehicle cursor state, applies left/right branch intent near junctions, and renders from sampled ribbons while keeping controls/movement model
